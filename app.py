...
DATA_URL = "https://github.com/maryamyaser/AmanFood/releases/download/v1.0-data/Food_Prices_in_Egypt.parquet"
...
def load_data():
    if not DATA_PATH.exists():
        # Not committed to the repo (too large) - fetch it from the
        # GitHub Release once, then cache it locally for next time.
